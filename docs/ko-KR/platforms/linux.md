...
네이티브 Linux 컴패니언 앱은 계획 중입니다. 빌드를 도와주실 분은 기여를 환영합니다.
...
5. `http://127.0.0.1:18789/`를 열고 토큰 붙여넣기
...
OpenClaw는 기본적으로 systemd **사용자** 서비스를 설치합니다. 공유 또는 항상 켜진 서버에는 **시스템** 서비스를 사용합니다. 전체 유닛 예제와 가이드는 [게이트웨이 런북](/gateway)에 있습니다.
